...
class TriangleFigureComponent extends FigureComponent implements IHoverable, IEditable, IConfigurable, ISelectable {
    private settings = new TriangleSettings();
...
export class DrawTriangleState extends FigureStateBase {
    ...
    protected addPoint(mouse: IMouse): void {
        ...
        if (this.count === 0) {
            this.figure = <TriangleFigureComponent>this.stack.addFigure((area, offset, size, settings, tcoord, vcoord) => {
                return new TriangleFigureComponent(area, offset, size, settings, tcoord, vcoord);
            });
...
class EditTriangleState implements IStateController {
    ...
    private line?: TriangleFigureComponent;
    ...
    public activate(board: IChartBoard, mouse: IMouse, stack?: IChartStack, activationParameters?: IHashTable<any>): void {
        ...
        if (activationParameters && activationParameters['component']) {
            this.line = <TriangleFigureComponent>activationParameters['component'];
        } else {
