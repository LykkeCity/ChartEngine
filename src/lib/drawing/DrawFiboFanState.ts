...
class FiboFanFigureComponent extends FigureComponent implements IHoverable, IEditable, IConfigurable, ISelectable {
    private settings = new FiboFanSettings();
...
export class DrawFiboFanState extends FigureStateBase {
    ...
    protected addPoint(mouse: IMouse): void {
        ...
        if (this.count === 0) {
            this.figure = <FiboFanFigureComponent>this.stack.addFigure((area, offset, size, settings, tcoord, vcoord) => {
                return new FiboFanFigureComponent(area, offset, size, settings, tcoord, vcoord);
            });
...
class EditFiboFanState implements IStateController {
    ...
    private line?: FiboFanFigureComponent;
    ...
    public activate(board: IChartBoard, mouse: IMouse, stack?: IChartStack, activationParameters?: IHashTable<any>): void {
        ...
        if (activationParameters && activationParameters['component']) {
            this.line = <FiboFanFigureComponent>activationParameters['component'];
        } else {
